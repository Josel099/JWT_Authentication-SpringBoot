...
public class JwtService {
    ...
    */
	...
	private final Claims extractAllClaims(String token) {
	    ...
	    */
	public String generateToken(com.example.user.model.User user) {
		...
		String token = Jwts
				...
				.issuedAt(new Date(System.currentTimeMillis())) // Set the issued at time of the JWT to the current time
				.expiration(new Date(System.currentTimeMillis()+24*60*60*1000))  // Set the expiration time of the JWT to 24 hours from the current time
